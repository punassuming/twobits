...
/**
 * Every uncaught exception the app has hit, captured by [com.twobits.pricedrop.data.local.CrashLogStore]
 * regardless of what feature was in use. Share exports the full stack traces as plain text so a
 * crash can be handed off without retyping or screenshotting a truncated banner.
 */
