...
* **New profile unified sheet** — "New Profile" now opens a single bottom sheet combining manual and AI-draft creation: Name field, Prompt field, a 4-tab model picker (GPT-5 mini / GPT-5 / GPT-5.4 / Local), "Draft with AI" primary button, and "Save profile" direct-save button
