 ...
 * and a Privacy policy row. Built on [AppSectionLabel]/[AppSectionCard]/[SettingsRow] (which
 * previously had zero call sites anywhere) instead of each app hand-rolling its own.
 */
@Composable
